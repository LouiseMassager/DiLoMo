...
class dilomoJointMover(object):
    ...
    def __init__(self):
        ...
        while dilomo_joints_data is None:
            try:
                ...
                rospy.logwarn("Time out 001" + str(joint_states_topic_name))
                pass
            if conter > 4:
                conter = 0
                break
    ...
    def dilomo_check_continuous_joint_value(self, joint_name, value, error=0.1):
        """
        Check the joint by name 'arm_left_joint_1', 'arm_left_joint_2', 'arm_left_joint_3', 'arm_left_joint_4',
        'arm_left_joint_5', 'arm_left_joint_6', 'arm_left_joint_7', 'arm_fight_joint_1', 'arm_fight_joint_2', 'arm_fight_joint_3',
        'arm_fight_joint_4', 'arm_fight_joint_5', 'arm_fight_joint_6', 'arm_fight_joint_7', 'leg_left_joint_1', 'leg_left_joint_2',
    ...
    # def dilomo_is_crying (self):

    #    self.dilomo_stand(arm_left_1=1.57, arm_left_2=0, arm_left_3=0, arm_left_4=1.57, arm_left_5=0, arm_left_6=0, arm_left_7=0, arm_right_1=-1.57, arm_right_2=0, arm_right_3=0, arm_right_4=-1.57, arm_right_5=0, arm_right_6=0, arm_right_7=0, leg_left_1=0, leg_left_2=1.57, leg_left_3=0, leg_left_4=0, leg_left_5=1.31, leg_right_1=0, leg_right_2=1.57, leg_right_3=0, leg_right_4=0, leg_right_5=1.31, head=0, body=0, neck=1.57)
    ...
    def dilomo_is_crying_2(self):
        self.dilomo_stand(arm_left_1=0, arm_left_2=0, arm_left_3=0, arm_left_4=0, arm_left_5=0,
                          arm_left_6=0, arm_left_7=0, arm_right_1=0, arm_right_2=0, arm_right_3=0, arm_right_4=0,
                          arm_right_5=0, arm_right_6=0, arm_right_7=0, leg_left_1=0, leg_left_2=0, leg_left_3=0,
                          leg_left_4=0, leg_left_5=0, leg_right_1=0, leg_right_2=0, leg_right_3=0, leg_right_4=0,
                          leg_right_5=0, head=1.57, body=0, neck=0)

    def dilomo_moverandomly(self):

        arm_left_1 = random.uniform(0, 0)
        arm_left_2 = random.uniform(0, 0)
        arm_left_3 = random.uniform(0, 0)
        arm_left_4 = random.uniform(0, 0)
        arm_left_5 = random.uniform(0, 0)
        arm_left_6 = random.uniform(0, 0)
        arm_left_7 = random.uniform(0, 0)

        arm_right_1 = random.uniform(0, 0)
        arm_right_2 = random.uniform(0, 0)
        arm_right_3 = random.uniform(0, 0)
        arm_right_4 = random.uniform(0, 0)
        arm_right_5 = random.uniform(0, 0)
        arm_right_6 = random.uniform(0, 0)
        arm_right_7 = random.uniform(0, 0)

        leg_left_1 = random.uniform(0, 0)
        leg_left_2 = random.uniform(0, 0)
        leg_left_3 = random.uniform(0, 0)
        leg_left_4 = random.uniform(0, 0)
        leg_left_5 = random.uniform(0, 0)

        leg_right_1 = random.uniform(0, 0)
        leg_right_2 = random.uniform(0, 0)
        leg_right_3 = random.uniform(0, 0)
        leg_right_4 = random.uniform(0, 0)
        leg_right_5 = random.uniform(0, 0)

        head = random.uniform(0, 0)
        body = random.uniform(0, 0)
        neck = random.uniform(0, 0)
        self.dilomo_stand(arm_left_1, arm_left_2, arm_left_3, arm_left_4, arm_left_5, arm_left_6, arm_left_7, arm_right_1, arm_right_2, arm_right_3, arm_right_4, arm_right_5,
                          arm_right_6, arm_right_7, leg_left_1, leg_left_2, leg_left_3, leg_left_4, leg_left_5, leg_right_1, leg_right_2, leg_right_3, leg_right_4, leg_right_5, head, body, neck)
