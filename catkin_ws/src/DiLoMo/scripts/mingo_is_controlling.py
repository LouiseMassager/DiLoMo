...
class dilomoJointMover(object):
    ...
    def dilomo_stand(self, arm_left_1, arm_left_2, arm_left_3, arm_left_4, arm_left_5, arm_left_6, arm_left_7,
        ...
        while not (similar_arm_left_1 and similar_arm_left_2 and similar_arm_left_3 and similar_arm_left_4 and similar_arm_left_5 and similar_arm_left_6 and similar_arm_left_7
            ...
            self.move_dilomo_all_joints(position_arm_left_1, position_arm_left_2, position_arm_left_3, position_arm_left_4, position_arm_left_5, position_arm_left_6, position_arm_right_7,
                                        ...
                                        position_head, position_body, position_neck)
    ...
    def dilomo_default(self):
        self.dilomo_stand(
            arm_left_1=0, arm_left_2=0, arm_left_3=0, arm_left_4=0, arm_left_5=0, arm_left_6=0, arm_left_7=0,
            arm_right_1=0, arm_right_2=0, arm_right_3=0, arm_right_4=0, arm_right_5=0, arm_right_6=0, arm_right_7=0,
            leg_left_1=0, leg_left_2=0, leg_left_3=0, leg_left_4=0, leg_left_5=0, 
            leg_right_1=0, leg_right_2=0, leg_right_3=0, leg_right_4=0, leg_right_5=0,
            neck=0,body=0,head=0)

    def dilomo_default1(self):
        self.dilomo_stand(
            arm_left_1=0, arm_left_2=-1.57, arm_left_3=0, arm_left_4=0, arm_left_5=1.57, arm_left_6=0, arm_left_7=1.57,
            arm_right_1=0, arm_right_2=-1.57, arm_right_3=0, arm_right_4=0, arm_right_5=1.57, arm_right_6=0, arm_right_7=1.57,
            leg_left_1=0, leg_left_2=0, leg_left_3=0, leg_left_4=0, leg_left_5=0, 
            leg_right_1=0, leg_right_2=0, leg_right_3=0, leg_right_4=0, leg_right_5=0,
            neck=0,body=0,head=0)
    ...
    def bend_upper_leg(self,val,t):
        ...
        for repetition in range(2):
            ...
            similar_2 = False
            while not (similar_1 and similar_2):
                self.move_leg_left_joint_2(position=val)
                self.move_leg_right_joint_2(position=val)
                # WARNING: THE COMMAND HAS TO BE PUBLISHED UNTIL THE GOAL IS REACHED
                # This is because, when publishing a topic, the first time doesn't always work.
                similar_1 = self.dilomo_check_continuous_joint_value(
                    joint_name="leg_left_joint_2", value=val)
                similar_2 = self.dilomo_check_continuous_joint_value(
                    joint_name="leg_right_joint_2", value=val)
                
                rate.sleep()
        rospy.loginfo("HERE")
        time.sleep(t)

    def bend_knee(self,val,t):
        ...
        for repetition in range(2):
            ...
            similar_2 = False
            while not (similar_1 and similar_2):
                self.move_leg_left_joint_4(position=val)
                self.move_leg_right_joint_4(position=val)
                # WARNING: THE COMMAND HAS TO BE PUBLISHED UNTIL THE GOAL IS REACHED
                # This is because, when publishing a topic, the first time doesn't always work.
                similar_1 = self.dilomo_check_continuous_joint_value(
                    joint_name="leg_left_joint_4", value=val)
                similar_2 = self.dilomo_check_continuous_joint_value(
                    joint_name="leg_right_joint_4", value=val)
                
                rate.sleep()
        rospy.loginfo("HERE")
        time.sleep(t)

    def bend_foot(self,val,t):
        ...
        for repetition in range(2):
            ...
            similar_2 = False
            while not (similar_1 and similar_2):
                self.move_leg_left_joint_5(position=val)
                self.move_leg_right_joint_5(position=val)
                # WARNING: THE COMMAND HAS TO BE PUBLISHED UNTIL THE GOAL IS REACHED
                # This is because, when publishing a topic, the first time doesn't always work.
                similar_1 = self.dilomo_check_continuous_joint_value(
                    joint_name="leg_left_joint_5", value=val)
                similar_2 = self.dilomo_check_continuous_joint_value(
                    joint_name="leg_right_joint_5", value=val)
                
                rate.sleep()
        rospy.loginfo("HERE")
        time.sleep(t)

    def bend_arm_left6(self,val,t):
        ...
        for repetition in range(2):
            ...
            similar_2 = False
            while not (similar_1 and similar_2):
                self.move_arm_left_joint_6(position=val)
                self.move_arm_left_joint_6(position=val)
                # WARNING: THE COMMAND HAS TO BE PUBLISHED UNTIL THE GOAL IS REACHED
                # This is because, when publishing a topic, the first time doesn't always work.
                similar_1 = self.dilomo_check_continuous_joint_value(
                    joint_name="arm_left_joint_6", value=val)
                similar_2 = self.dilomo_check_continuous_joint_value(
                    joint_name="arm_left_joint_6", value=val)
    ...
    def bend_arm_right6(self,val,t):
        ...
        for repetition in range(2):
            ...
            similar_2 = False
            while not (similar_1 and similar_2):
                self.move_arm_right_joint_6(position=val)
                self.move_arm_right_joint_6(position=val)
                # WARNING: THE COMMAND HAS TO BE PUBLISHED UNTIL THE GOAL IS REACHED
                # This is because, when publishing a topic, the first time doesn't always work.
                similar_1 = self.dilomo_check_continuous_joint_value(
                    joint_name="arm_right_joint_6", value=val)
                similar_2 = self.dilomo_check_continuous_joint_value(
                    joint_name="arm_right_joint_6", value=val)
    ...
    def bend_neck(self,val,t):
        ...
        for repetition in range(2):
            ...
            similar_2 = False
            while not (similar_1 and similar_2):
                self.move_neck_joint(position=val)
                self.move_neck_joint(position=val)
                # WARNING: THE COMMAND HAS TO BE PUBLISHED UNTIL THE GOAL IS REACHED
                # This is because, when publishing a topic, the first time doesn't always work.
                similar_1 = self.dilomo_check_continuous_joint_value(
                    joint_name="neck_joint", value=val)
                similar_2 = self.dilomo_check_continuous_joint_value(
                    joint_name="neck_joint", value=val)
                
                rate.sleep()
        rospy.loginfo("HERE, 10sec")
        time.sleep(t)         

    def bend_head(self,degreee5,t):
        ...
        for repetition in range(2):
            ...
            similar_2 = False
            while not (similar_1 and similar_2):
                self.move_head_joint(position=degreee5)
                self.move_head_joint(position=degreee5)
                # WARNING: THE COMMAND HAS TO BE PUBLISHED UNTIL THE GOAL IS REACHED
                # This is because, when publishing a topic, the first time doesn't always work.
                similar_1 = self.dilomo_check_continuous_joint_value(
                    joint_name="head_joint", value=degreee5)
                similar_2 = self.dilomo_check_continuous_joint_value(
                    joint_name="head_joint", value=degreee5)
    ...
    def movement_random_loop(self):
        ...
        self.dilomo_default()
        time.sleep(10)
        self.dilomo_default1()
        
        time.sleep(5)
        self.dilomo_stand(
        arm_left_1=1.57, arm_left_2=0, arm_left_3=0, arm_left_4=0, arm_left_5=0, arm_left_6=3.14, arm_left_7=1.57,
        arm_right_1=1.57, arm_right_2=0, arm_right_3=0, arm_right_4=0, arm_right_5=0, arm_right_6=3.14, arm_right_7=1.57,
        leg_left_1=0, leg_left_2=0, leg_left_3=0, leg_left_4=0, leg_left_5=0, 
        leg_right_1=0, leg_right_2=0, leg_right_3=0, leg_right_4=0, leg_right_5=0,
        neck=0,body=0,head=0)
        ...
        self.dilomo_stand(
        arm_left_1=1.57, arm_left_2=0, arm_left_3=0, arm_left_4=-1.57, arm_left_5=0, arm_left_6=3.14, arm_left_7=1.57,
        arm_right_1=-1.57, arm_right_2=0, arm_right_3=0, arm_right_4=1.57, arm_right_5=0, arm_right_6=3.14, arm_right_7=1.57,
        leg_left_1=0, leg_left_2=0, leg_left_3=0, leg_left_4=0, leg_left_5=0, 
        leg_right_1=0, leg_right_2=0, leg_right_3=0, leg_right_4=0, leg_right_5=0,
        neck=0,body=0,head=0)
        ...
        self.bend_head(1.57,0)
        self.bend_neck(1.57,0)

        time.sleep(100)

        rospy.loginfo("step1 - falling")
        self.bend_foot(-0.4,0)
        self.bend_knee(0.3,0) 
        time.sleep(2)
        
        rospy.loginfo("Wait for balance 10 sec")
        while not rospy.is_shutdown():            

            
            rospy.loginfo("step2 - trasform_ foot")
            self.bend_foot(1.31,0)

            self.bend_upper_leg(1.57,10)

            time.sleep(0)
            rospy.loginfo("step3 - trasform")
            self.bend_arm_left6(3.14,0)     
            self.bend_arm_right6(3.14,0)

            time.sleep(0)
            rospy.loginfo("step4 - final")	



            self.dilomo_stand(
            arm_left_1=0, arm_left_2=0, arm_left_3=0, arm_left_4=0, arm_left_5=1.57, arm_left_6=3.14, arm_left_7=1.57,
            arm_right_1=0, arm_right_2=0, arm_right_3=0, arm_right_4=0, arm_right_5=1.57, arm_right_6=3.14, arm_right_7=1.57,
            ...
            self.dilomo_stand(
            arm_left_1=0, arm_left_2=0, arm_left_3=0, arm_left_4=0, arm_left_5=0, arm_left_6=3.14, arm_left_7=1.57,
            arm_right_1=0, arm_right_2=0, arm_right_3=0, arm_right_4=0, arm_right_5=0, arm_right_6=3.14, arm_right_7=1.57,
            leg_left_1=0, leg_left_2=1.57, leg_left_3=0, leg_left_4=0, leg_left_5=1.31, 
            leg_right_1=0, leg_right_2=1.57, leg_right_3=0, leg_right_4=0, leg_right_5=1.31,
            neck=0,body=0,head=0)
